...
import { Eye, Users, Clock, CheckCircle2, AlertCircle } from "lucide-react";
...
export default function AdminDashboardMainPage() {
  ...
  return (
    <div className="p-3 sm:p-5 space-y-4 max-w-5xl mx-auto font-sans text-xs">
      ...
      {/* Quick Stats Widget (Compact Balanced Square / Box Cards) */}
      ...
      {/* Orders Table Card (Box proportioned container) */}
